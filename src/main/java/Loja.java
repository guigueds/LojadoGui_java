...
public class Loja {
    public static void boasVindas() {
        ...
        System.out.println("-------------------- Bem-vindo a Loja do Gui -------------------");
    }

    public static void agradecimento() {
        System.out.println("--------------------------------------------------------");
        System.out.println("\t A Loja do Gui agradece. Volte sempre!");
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Digite 1 para pagamanto com cartão no débito e você terá 30% de desconto sobre o valor total porque aqui é a loja do Gui!");
        ...
        while(pagamento != 1 || pagamento != 2 || pagamento != 3 || pagamento != 4 || pagamento != 5) {
            ...
            System.out.println("Digite 1 para pagamanto com cartão débito e você terá 30% de desconto sobre o valor total porque aqui é a Loja do Gui!");
            System.out.println("Digite 2 para pagamanto à vista (dinheiro ou pix) e você terá 10% de desconto sobre o valor total.");
            System.out.println("Digite 3 para pagamanto à vista no crédito.");
        ...
        if(pagamento== 1) {
            ...
            System.out.println("Excelente escolha!! O cartão débito te proporcionou R$ "+-desconto+"  de desconto!");
            ...
            System.out.println("1x no crédito você não economiza! Mude para o débito para obter 30% de desconto!");
